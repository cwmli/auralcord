    ...
    if (this.props.profile && !this.props.profile.isFetching) {
      ...
      return (
        <div className="pv3 ph5 w-100">
          <a className="flex items-center justify-center flex-column link dim" 
             href={this.props.profile.data.external_urls.spotify}>
            <img src={this.props.profile.data.images[0] ? this.props.profile.data.images[0].url : `https://ui-avatars.com/api/?size=256&name=${this.props.profile.data.display_name}`} 
